...
# ---------------- CONFIG ----------------
BOT_TOKEN = "8452833439:AAF0KJj2I6nK0_liNs1_hFchzDXe_Pj7ajw"
ADMIN_ID = 7819854683
bot = telebot.TeleBot(BOT_TOKEN)

DATA_FILE = "botdata.json"
NUMBERS_DIR = "numbersss"
...
OTP_GROUP_IDS = ["-1002708048327"]  # Updated with multiple group IDs
CHANNEL_LINK = "https://t.me/+l2KEXU3a-4JmZTNk"
DEVELOPER_ID = "@AnsarOTP_BOT"
...
def start(message):
    ...
    if not_joined:
        ...
        markup.add(types.InlineKeyboardButton("🚀 Join Channel 1", url="https://t.me/+l2KEXU3a-4JmZTNk"))
        markup.add(types.InlineKeyboardButton("🚀 Join Channel 2", url="https://t.me/+BHLVA0ammA1lYWQ1"))
